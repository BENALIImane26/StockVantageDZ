...
class _EtatStockPageState extends State<EtatStockPage> {
  ...
  Widget _buildStockCard(Map<String, dynamic> item) {
    Color statusColor;
    if (item['status'] == 'green') statusColor = Colors.green;
    else if (item['status'] == 'yellow') statusColor = Colors.orange;
                  ...
                  (i) => Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(item['history'][i], style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                ),
